...
return[
    ...
    'branding_intro' => 'To get inspired from the nature is a good way to make a piece if art, but to create the inspiration is the art itself. <br>Our team helps you at creating your art from penciles and papers to the white board and the media. <br>We help you at the following : <br>- Logo concept and designing. <br>- Brand identity creation. <br>- Paper and B.Cards design. <br>- Brand guid lines.',
    ...
    'web_intro' => 'A good Front-end or strong Back-end ? <br>All the job is about to balance the ratio. <br>Luckly we have hte best ratio 33%. <br>We help you at the following : <br>- Product & service websites. <br>-B2B and B2C eCommerce sites. <br>- UI/UX design. <br>- Front and Back-end development.',
