...
@section('content')
    ...
    <div class="container">
        ...
        <div class="offer" id="offer" data-service='UI & UX'>
            ...
            <input type="checkbox" class="check-box" id="fo" name="fo" value="<br>-XD file source" price="50">
            <label for="fo"> @lang('site.ui-add-1')</label><br>
            <input type="checkbox" class="check-box" id="so" name="so" value="<br>-All assets" price="30">
            <label for="so"> @lang('site.ui-add-2')</label><br>
            <input type="checkbox" class="check-box" id="to" name="to" value="<br>-Web development" price="50">
