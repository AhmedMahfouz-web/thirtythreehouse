...
@section('content')
    ...
    <div class="container">
        ...
        <div class="offer" id="offer" data-service="Packging">
            ...
            <input type="checkbox" class="check-box" id="fo" name="fo" value="<br>-Mockup preview" price="50">
            <label for="fo"> @lang('site.packaging-add-1')</label><br>
            <input type="checkbox" class="check-box" id="so" name="so" value="<br>-3D product" price="30">
            <label for="so"> @lang('site.packaging-add-2')</label><br>
            <input type="checkbox" class="check-box" id="to" name="to" value="<br>-Digital marketing" price="50">
